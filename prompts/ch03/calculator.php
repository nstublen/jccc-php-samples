...
<form action="calculator.php" method="post">
	...
	<p>Ave. Price Per Gallon: <span class="input">
        <!-- TODO: Check (echo) the gallon_price that matches the POST if it's set -->
	...
	<p>Fuel Efficiency: <select name="efficiency">
        <!-- TODO: Select (echo) the efficiency that matches the POST if it's set -->
...
// TODO: Create a generic function for creating radio buttons for gallon_price.

// TODO: Create a function to calculate the estimated cost.
